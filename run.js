...
var transitions2 = [
	...
	/*6*/[{nextState: 13, replacement: 'D', direction: true}, {nextState: 6, replacement: '1', direction: true}, {nextState: 13, replacement: '0', direction: true}, {nextState: 13, replacement: 'x', direction: true}, {nextState: 13, replacement: 'y', direction: true}, {nextState: 13, replacement: 'z', direction: true}, {nextState: 13, replacement: '#', direction: true}, {nextState: 6, replacement: '@', direction: true}, {nextState: 7, replacement: '<', direction: false}],
...
function singleStep() {
	if(machineInitialized) {
		if(((currentState === 24 && operationOption === 0) || (currentState === 13 && operationOption === 1)) && startSymbolAttached) {
			clearInterval(intervalVariable);
		}
